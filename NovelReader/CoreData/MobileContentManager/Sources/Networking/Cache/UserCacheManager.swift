...
public protocol UserCacheProtocol {
    ...
    @discardableResult
    static func setCacheObject(_ data: Codable, key: String, cacheType: UserCacheType) -> Bool
...
public class UserCacheManager: UserCacheProtocol {
    ...
    private enum PrivateKeys: String {
    ...
    public static var httpAdditionalHeaders: [String: String]? {
        get {
            UserCacheManager.getCachedObject(forKey: PrivateKeys.httpHeader, cacheType: .application) as? [String: String]
        }
        set {
            let data = newValue
            UserCacheManager.setCacheObject(data, forKey: PrivateKeys.httpHeader, cacheType: .application)
        }
    }
}
...
public extension UserCacheProtocol {
    ...
    // Save data to Session object
    @discardableResult
    static func setCacheObject(_ data: Codable, key: String, cacheType: UserCacheType = .user) -> Bool {
    ...
    @discardableResult
    static func setCacheObject(_ data: Codable, forType keyType: AnyClass, cacheType: UserCacheType = .user) -> Bool {
...
private extension UserCacheProtocol {
    ...
    @discardableResult
    static func setCacheObject<T>(_ data: Codable?, forKey keyType: T, cacheType: UserCacheType) -> Bool where T: Hashable {
